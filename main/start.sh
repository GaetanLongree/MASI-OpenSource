...
INSERT INTO records (domain_id, name, content, type,ttl,prio) VALUES (1,'$TLD_DOMAIN_PTR.in-addr.arpa','iglu.lu admin.iglu.lu 1 10380 3600 604800 3600','SOA',86400,NULL);
INSERT INTO records (domain_id, name, content, type,ttl,prio) VALUES (1,'$TLD_DOMAIN_PTR.in-addr.arpa','iglu.lu','NS',86400,NULL);
INSERT INTO records (domain_id, name, content, type,ttl,prio) VALUES (1,'$MAIL_IP_HOST_ID.$TLD_DOMAIN_PTR.in-addr.arpa','mail.iglu.lu','A',120,NULL);
EOF
docker cp records.sql db-dns:/tmp/
docker exec db-dns psql -f /tmp/records.sql pdns -U admin
